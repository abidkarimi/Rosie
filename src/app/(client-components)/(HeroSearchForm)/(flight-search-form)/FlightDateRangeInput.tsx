...
const FlightDateRangeInput: FC<FlightDateRangeInputProps> = ({
  ...
  const onSubmitSearchOnFlights = (dates: [Date | null, Date | null]) => {
    console.log(`On Submit Search On Flights startDate ${startDate}, ${endDate} `)
  };
            ...
            >
              ...
              {hasButtonSubmit && (
                <div className="pr-2 xl:pr-4">
                  {/* <SearchButton 
                   onClick={() => onSubmitSearchOnFlights([null, null])}
                   /> */}
                   <div className="pr-2 xl:pr-4">
                      <ButtonSubmit href="/your-booking-details" />
                    </div>
                </div>
              )}
            </div>
